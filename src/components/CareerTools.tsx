...
import { Brain, Target, ArrowRightLeft, HelpCircle, Code, Briefcase, ChevronRight, MessageSquare } from 'lucide-react';
...
export const CareerTools: React.FC<CareerToolsProps> = ({ isDarkMode, engineConfig, selectedEngine }) => {
