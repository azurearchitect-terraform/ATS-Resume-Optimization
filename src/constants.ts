export const RESUME_DATA = {
  name: "HARNISH JARIWALA",
  title: "CLOUD & COLLABORATION ENGINEER II (MICROSOFT ENGAGEMENT)",
  location: "Surat, Gujarat, India",
  workLocation: "Hyderabad, Telangana",
  contact: "+91-8980161289",
  email: "param_jariwala@yahoo.com",
  linkedin: "HarnishJariwala",
  professionalSummary: [
    "Senior Cloud Infrastructure professional with 16 years of overall IT experience, including 6+ years specializing in Microsoft Azure. Strong expertise in Azure infrastructure architecture, hybrid cloud, high availability, disaster recovery, governance, monitoring, and cost optimization.",
  ...
  workExperience: [
    ...
    {
      company: "M&M Software Development Centre India",
      location: "Vadodara",
    ...
    {
      company: "AGILUS Diagnostics (formerly SRL Ltd.)",
      location: "Mumbai",
  ...
  projects: [
    {
      ...
      period: "2022–2024",
      details: [
        "Led phased hybrid cloud migrations across compute, networking, and identity services.",
        "Designed and implemented Azure Landing Zones aligned with security, disaster recovery, and compliance standards.",
        "Integrated governance controls including RBAC, Azure Policy, and backup frameworks.",
        "Improved reliability and availability through architecture standardization and resilience planning."
      ]
    },
    {
      title: "COST OPTIMIZATION & INFRASTRUCTURE MATURITY PROGRAMS (2019–2022)",
      period: "2019–2022",
      details: [
        "Delivered cost governance and optimization initiatives through workload right-sizing and lifecycle management.",
        "Strengthened backup and recovery practices to improve operational resilience.",
        "Introduced standardized governance supporting healthcare regulatory requirements.",
        "Enhanced monitoring and incident response workflows, reducing operational risk."
      ]
    }
  ]
};
